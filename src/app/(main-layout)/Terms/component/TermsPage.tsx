  ...
  return (
    <div id="terms-page">
      <Stack>
        ...
        <Stack sx={{ ml: 5 }}>
          <ul className="orderList" style={{ listStyle: "square" }}>
            <li>
              Design Check:
              <dt>
                PRINTOUT will perform a basic design check on files submitted
                for printing. However, it is the customer’s responsibility to
                ensure that all artwork and files are print-ready. We do not
                assume liability for design errors, misspellings, or incorrect
            ...
            <li>
              ...
              <dt>
                ...
                your screen or provided in a physical sample due to differences
                in color calibration, materials, and printing processes. CMYK
                and RGB are two different color models used in various contexts,
                and there can be significant differences between the colors
                represented in these models. Here’s an explanation of the key
                distinctions:
              </dt>
              <ol>
                ...
                <ul>
                  <li style={{ fontWeight: 600 }}>
                    CMYK:
                    <dt>
                      Uses cyan, magenta, yellow, and black as its primary
                      colors.
                    </dt>
                  </li>
                  <li style={{ fontWeight: 600 }}>
                ...
                <ul>
                  ...
                  <li style={{ fontWeight: 600 }}>
                    RGB:
                    <dt>
                      Has a larger color gamut and can represent a wider range
                      of colors, including bright and highly saturated hues.
                    </dt>
                  </li>
                </ul>
                ...
                <ul>
                  <li style={{ fontWeight: 600 }}>
                    ...
                    <dt>
                      ...
                      magazines, and other printed materials. It is essential
                      for accurate color reproduction in the print industry.
                    </dt>
                  </li>
                  <li style={{ fontWeight: 600 }}>
                    RGB:
                ...
                <ul>
                  ...
                  <li style={{ fontWeight: 600 }}>
                    RGB:
                    <dt>
                      Represents colors by specifying the intensity of each of
                      the three primary colors (Red, Green, and Blue) on a scale
                      from 0 to 255.
                    </dt>
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    some color shifts or inaccuracies because the color gamuts
                    of the two models differ. Not all RGB colors can be
                    accurately reproduced in CMYK, and vice versa.
                  </li>
                </ul>
              </ol>
            </li>
        ...
        >
          In summary, the key difference between CMYK and RGB is their color
          model and primary colors, which lead to variations in color
          representation. It’s important to use the appropriate color model for
          your specific needs, whether it’s for print (CMYK) or digital display
          (RGB), and be aware of potential color differences when converting
        ...
        <Stack sx={{ ml: 5 }}>
          <ul className="orderList" style={{ listStyle: "square" }}>
            ...
            <li>
              Product Assurance:
              <dt>
                PRINTOUT guarantees the quality of our products. If you receive
                a product with manufacturing defects or errors on our part,
                please contact us same day of receiving the order to arrange for
            ...
            <li>
              ...
              <dt>
                ...
                variations in texture or appearance due to the nature of
                printing materials.
              </dt>
            </li>
            <li>
            ...
            <li>
              Payments:
              <dt>
                Payment is required at least 50% at the time of placing the
                order and the remaining 50% to be determined how it will be paid
                (Cash , Visa , Instapay , …etc), unless otherwise agreed upon in
                writing. We accept various payment methods, including
                credit/debit cards and electronic transfers. Payment details
            ...
            <li>
              ...
              <dt>
                ...
                delivery. Delivery times may vary depending on the destination.
                We will provide an estimated delivery date upon order
                confirmation. It is the customer’s responsibility to provide
                accurate delivery information. PRINTOUT is not responsible for
                delivery delays or issues caused by incorrect address details.
              </dt>
            </li>
            <li>
              Order Cancellation:
            ...
            <li>
              ...
              <dt>
                ...
                service team before proceeding with your order. Your
                satisfaction is our priority, and we are committed to providing
